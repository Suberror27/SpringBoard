...
console.log(`First location is "${first}", the Second location is "${second}"`);
...
function doorSequence ({upper, lower, middle = remaining.third}) {
	console.log(`${upper}, ${middle}, ${lower}`)
};
doorSequence(doorCode);
...
const [firstElement, secondElement, ...restOfElements] = elements;
...
// Or
const firstStome = stones[0];
const sixthStome = stones[5];
...
function castSpell([spell1, spell2]) {
